...
import { buildProductCard } from '../../scripts/product-card.js';
  ...
  function render() {
    ...
    grid.innerHTML = products.map((p, i) => {
      ...
      return buildProductCard(p, {
        sold,
        fmt,
        imgAttrs: `width="600" height="800" ${loadAttrs}`,
        wishlistButton: `<button class="product-wishlist" data-id="${p.id}" aria-label="Wishlist">♡</button>`,
        savingHtml: saving > 0 ? `<span class="product-saving">-${saving}%</span>` : '',
        footer: `<div class="product-card-foot">
